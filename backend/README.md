...
## Project Structure
    ...
    ├── testapiautostoryboa_61902  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_61902`
...
2. Clone this repo and `cd testapiautostoryboa_61902`
